...
ggsave("figures/main/chains.jpeg", out, height = 8, width = 3)
...
write.csv(links_consensus, "Output/trees/links_consensus.csv", row.names=FALSE)
...
pemba_maps <-
  ...
  labs(tag = "C")
ggsave("figures/main/pemba_maps.jpeg", pemba_maps, height = 3, width = 8)
...
chain_ts_hz <-
  ...
  labs(tag = "A")
ggsave("figures/main/chain_ts_hz.jpeg", chain_ts_hz, height = 3, width = 8)
